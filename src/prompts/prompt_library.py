...
Provide your analysis:"""
    ...
    def build_synthesis_prompt(self,
                              ...
                              domain: str) -> str:
        """
        Build advanced synthesis prompt with STRUCTURED OUTPUT
        ...
        Returns:
            Optimized synthesis prompt with structure requirements
        """
        ...
        style_templates = {
            ...
            'technical': {
                ...
                'tone': 'Highly technical, assume expert audience'
            }
        }
...
**Quality Standards:**
1. Cite specific papers when making claims (use paper titles)
...
- ✓ Are all {len(papers)} major papers incorporated?
- ✓ Is the narrative coherent and well-structured?
- ✓ Would a researcher find this valuable?

**OUTPUT FORMAT:**
You MUST use the section headers shown above (##) with emoji icons.
Start with ## 📌 and end with ## ✅

Generate the structured research synthesis now:"""
